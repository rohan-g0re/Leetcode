...
4. "not pick" can be done whatsoever (valid or invalid current)
    - bcoz even if its valid then the increase can cancel the upcoming lenght --> eg: 1, 10, 2, 3, 4, 5 --> picking 10 is valid but it will reduces the length of LIS as it would have been 12345
```
